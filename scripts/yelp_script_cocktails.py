...
URL = "https://api.yelp.com/v3/businesses/search?location=\"Washington DC\"&categories=diverbars"
...
divebar_fpath = "./yelp_jsons/yelp_cocktailbars.json"
...
for bars in yelp_api_results["businesses"]:
    ...
    # FIX ME: HARDCODED CAT ID FOR DIVE
    category_val = (bars['id'], 9)
