...
URL = "https://api.yelp.com/v3/businesses/search?location=\"Washington DC\"&categories=speakeasies"
...
divebar_fpath = "./yelp_jsons/yelp_speakeasies.json"
